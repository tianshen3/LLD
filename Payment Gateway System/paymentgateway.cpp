...
//Banking System Interface and implementation ( Strategy for actual concrete payment logic)
class BankingSystem {
    public:
...
class PaymentGateway {
    ...
    //Template method defining the standard flow
...
//proxy class that wraps up a payment gateway to add retries to proxy
...
//defining static instance
GatewayFactory GatewayFactory::instance;

//unified API service(singelton)
...
//controller class for all client requests
