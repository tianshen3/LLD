...
//concrete Notification : simple text modification
...
//Concrete Decorator to add timestamp to the content;
class TimestampDecorator : public INotificationDecorator {
    public:
    TimestampDecorator(INotification* n) : INotificationDecorator(n){}

    string getContent() const override {
        return "[some date]" + notification->getContent();
    }
};

//Concrete Decorator to append a signature to the content
...
class NotificationService {
    ...
    vector<INotification*> notifications; // a kind of storage to keep all the notifications;
    ...
    //Exposing the observable so the observers can attach
