...
//factory design pattern to instantiate the product object;
...
// an abstract inventory store to add more types of future inventory 
// this can thought of as low level layer
class InventoryStore {
    public:
    virtual ~InventoryStore() {}
    virtual void addProduct(Product* prod, int qty) = 0;
    virtual void removeProduct(int sky, int qty) = 0;
    virtual int checkStock(int sku) = 0;
    virtual vector<Product*> listAvailableProducts() = 0;
};

// a concrete inventory class 
...
//products replinshing strategies;
